...
/***/ "./src/js/import/jQuery.Brazzers-Carousel.min.js":
/*!*******************************************************!*\
  !*** ./src/js/import/jQuery.Brazzers-Carousel.min.js ***!
  \*******************************************************/
/*! no static exports found */
...
/* harmony import */ var _import_slick_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./import/slick.min */ "./src/js/import/slick.min.js");
/* harmony import */ var _import_slick_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_import_slick_min__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _import_jquery_formstyler_min__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./import/jquery.formstyler.min */ "./src/js/import/jquery.formstyler.min.js");
/* harmony import */ var _import_jquery_formstyler_min__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_import_jquery_formstyler_min__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _import_jQuery_Brazzers_Carousel_min__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./import/jQuery.Brazzers-Carousel.min */ "./src/js/import/jQuery.Brazzers-Carousel.min.js");
/* harmony import */ var _import_jQuery_Brazzers_Carousel_min__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_import_jQuery_Brazzers_Carousel_min__WEBPACK_IMPORTED_MODULE_3__);
...
$(document).ready(function () {
  ...
  $('.slider-car-big').slick((_$$slick3 = {
    ...
    fade: true,
    swipe: false
  }, _defineProperty(_$$slick3, "arrows", false), _defineProperty(_$$slick3, "asNavFor", '.slider-car-thumbs'), _$$slick3));
  ...
  $('.hamburger').click(function () {
    ...
    if ($(this).hasClass('hamburger_active')) {
      $('.top-menu').addClass('top_menu_active'); // $('.top-menu > li > a').each(function(index, el) {
      //     setTimeout(function() {
      //         $(el).addClass('showed');
      //     }, index * 70);
      // });
      ...
      $('.top-menu').removeClass('top_menu_active'); // $('.top-menu').find('.showed').removeClass('showed');
  ...
  $(window).on('load resize', function () {
    ...
    if (width < '576') {
      ...
      $('.auto-in-stock__slider').slick('unslick'); // $('.top-slide-mobile').slick({
      //     infinite: true,
      //     slidesToShow: 1,
      //     slidesToScroll: 1,
      //     dots: true,
